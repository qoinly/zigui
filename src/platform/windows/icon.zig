...
pub const WinIconSystem = struct {
    ...
    pub fn name_for(self: *Self, ic: Icon) []const u8 {
        ...
        return switch (ic) {
            ...
            .lock => "\u{E72E}", // Lock
            .layers => "\u{E81E}", // MapLayers (closest to layers)
            .square_terminal => "\u{E756}", // CommandPrompt
            .folder_dot => "\u{E8B7}", // Folder (no dot variant)
            .folder_open_dot => "\u{E838}", // FolderOpen
            .folder_open => "\u{E838}", // FolderOpen
