// Linux running-app icon source. rasterize returns null (no platform lookup),
...
pub const LinuxAppIcons = struct {
    allocator: std.mem.Allocator,

    pub fn init(allocator: std.mem.Allocator) LinuxAppIcons {
        return .{ .allocator = allocator };
    }

    pub fn deinit(self: *LinuxAppIcons) void {
        _ = self;
    }

    pub fn platform_app_icons(self: *LinuxAppIcons) aicon.PlatformAppIcons {
