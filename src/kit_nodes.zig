...
pub const Ta = struct {
    ...
    wrap: bool = true,
    wrap_indent: bool = false, // hanging indent for wrapped continuation rows
    bordered: bool = true,
    line_numbers: bool = false,
    match_ranges: []const [2]u32 = &.{},
    active_match: i32 = -1,
    error_ranges: []const [2]u32 = &.{},
...
pub const TextInputOpts = struct {
    ...
    frameless: bool = false, // skip the box (bg + border) for an inline/borderless field
