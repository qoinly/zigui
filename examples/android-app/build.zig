...
// The Android example as a zero-Java consumer: it supplies only Zig (src/main.zig)
// plus a manifest and calls zigui.androidApk, which ships the Java shell
...
pub fn build(b: *std.Build) void {
    ...
    zigui.androidApk(b, .{
        ...
        .manifest = b.path("AndroidManifest.xml"),
